...
SHORT_TO_LONG = dict((v, k) for k, v in list(LONG_TO_SHORT.items()))
...
class Images(object):
    ...
    def handle_request(self, path):
        ...
        query = dict(iter(list(request.args.items())))
        ...
        # Expand kwargs.
        query = dict((SHORT_TO_LONG.get(k, k), v) for k, v in list(query.items()))
