...
var banner = ['/*!\n',
    ' * Start Bootstrap - sbadmin2 v3.3.7',
...
gulp.task('less', function() {
    return gulp.src('sbadmin/less/sb-admin-2.less')
        .pipe(less())
        .pipe(header(banner))
        .pipe(gulp.dest('sbadmin/dist/css'))
...
// Run everything
var default_task = gulp.task('default', gulp.series('minify-css', 'minify-js', 'copy'));
...
var dev = gulp.task('dev', gulp.series('browserSync', 'less', 'minify-css', 'js', 'minify-js'), function() {
