...
from oy.boot.exts.sqla import db
...
class OyResourceType(MethodViewType):
...
class OyResource(with_metaclass(OyResourceType, Resource)):
    """
...
class OySchemaOpts(SchemaOpts):
    def __init__(self, meta):
        super(OySchemaOpts, self).__init__(meta)
        self.json_module = json


class OyModelSchema(ma.ModelSchema):
    OPTIONS_CLASS = OySchemaOpts
